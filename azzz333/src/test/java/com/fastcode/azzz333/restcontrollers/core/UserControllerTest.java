...
import com.fastcode.azzz333.domain.core.authorization.userpreference.IUserpreferenceManager;
...
public class UserControllerTest {
	...
	public void UpdateUser_UserDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		String json = ow.writeValueAsString(user);
		 ...
		 org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(put("/user/999").contentType(MediaType.APPLICATION_JSON).content(json))
