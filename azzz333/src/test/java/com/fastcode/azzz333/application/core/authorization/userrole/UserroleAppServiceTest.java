package com.fastcode.azzz333.application.core.authorization.userrole;
...
import com.fastcode.azzz333.domain.core.authorization.userrole.*;
import com.fastcode.azzz333.commons.search.*;
import com.fastcode.azzz333.application.core.authorization.userrole.dto.*;
import com.fastcode.azzz333.domain.core.authorization.userrole.QUserroleEntity;
import com.fastcode.azzz333.domain.core.authorization.userrole.UserroleEntity;
import com.fastcode.azzz333.domain.core.authorization.userrole.UserroleId;
import com.fastcode.azzz333.domain.core.authorization.role.RoleEntity;
import com.fastcode.azzz333.domain.core.authorization.role.IRoleRepository;
import com.fastcode.azzz333.domain.core.authorization.user.UserEntity;
import com.fastcode.azzz333.domain.core.authorization.user.IUserRepository;
...
public class UserroleAppServiceTest {
    ...
    public void createUserrole_UserroleIsNotNullAndUserroleDoesNotExist_StoreUserrole() { 
        ...
        Mockito.when(_userroleRepository.save(any(UserroleEntity.class))).thenReturn(userroleEntity);
	   	...
	   	Assertions.assertThat(_appService.create(userroleInput)).isEqualTo(_mapper.userroleEntityToCreateUserroleOutput(userroleEntity));
...
//		search.setOperator("equals");
	...
	public void  search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QUserroleEntity.class), any(HashMap.class), any(HashMap.class));
   ...
   //Role
	...
	public void GetRole_IfUserroleIdAndRoleIdIsNotNullAndUserroleExists_ReturnRole() {
		...
		Assertions.assertThat(_appService.getRole(userroleId)).isEqualTo(_mapper.roleEntityToGetRoleOutput(roleEntity, userrole));
	}
   ...
   //User
	...
	public void GetUser_IfUserroleIdAndUserIdIsNotNullAndUserroleExists_ReturnUser() {
		...
		Assertions.assertThat(_appService.getUser(userroleId)).isEqualTo(_mapper.userEntityToGetUserOutput(userEntity, userrole));
	}
