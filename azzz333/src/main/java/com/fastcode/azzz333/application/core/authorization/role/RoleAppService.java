package com.fastcode.azzz333.application.core.authorization.role;
...
import com.fastcode.azzz333.domain.core.authorization.role.QRoleEntity;
...
public class RoleAppService implements IRoleAppService {
	...
	protected BooleanBuilder searchKeyValuePair(QRoleEntity role, Map<String,SearchFields> map,Map<String,String> joinColumns) {
