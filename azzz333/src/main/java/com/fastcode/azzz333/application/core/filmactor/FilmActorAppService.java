package com.fastcode.azzz333.application.core.filmactor;

import lombok.NonNull;
import lombok.RequiredArgsConstructor;
import com.fastcode.azzz333.application.core.filmactor.dto.*;
import com.fastcode.azzz333.domain.core.filmactor.IFilmActorRepository;
import com.fastcode.azzz333.domain.core.filmactor.QFilmActorEntity;
import com.fastcode.azzz333.domain.core.filmactor.FilmActorEntity;
import com.fastcode.azzz333.domain.core.filmactor.FilmActorId;
import com.fastcode.azzz333.domain.core.actor.IActorRepository;
import com.fastcode.azzz333.domain.core.actor.ActorEntity;
import com.fastcode.azzz333.domain.core.film.IFilmRepository;
import com.fastcode.azzz333.domain.core.film.FilmEntity;
import com.fastcode.azzz333.commons.search.*;
		...
		for (Map.Entry<String, SearchFields> details : map.entrySet()) {
			if(details.getKey().replace("%20","").trim().equals("actorId")) {
				if(details.getValue().getOperator().equals("equals") && StringUtils.isNumeric(details.getValue().getSearchValue()))
					builder.and(filmActor.actorId.eq(Integer.valueOf(details.getValue().getSearchValue())));
				else if(details.getValue().getOperator().equals("notEqual") && StringUtils.isNumeric(details.getValue().getSearchValue()))
					builder.and(filmActor.actorId.ne(Integer.valueOf(details.getValue().getSearchValue())));
				else if(details.getValue().getOperator().equals("range"))
				{
				   if(StringUtils.isNumeric(details.getValue().getStartingValue()) && StringUtils.isNumeric(details.getValue().getEndingValue()))
                	   builder.and(filmActor.actorId.between(Integer.valueOf(details.getValue().getStartingValue()), Integer.valueOf(details.getValue().getEndingValue())));
                   else if(StringUtils.isNumeric(details.getValue().getStartingValue()))
                	   builder.and(filmActor.actorId.goe(Integer.valueOf(details.getValue().getStartingValue())));
                   else if(StringUtils.isNumeric(details.getValue().getEndingValue()))
                	   builder.and(filmActor.actorId.loe(Integer.valueOf(details.getValue().getEndingValue())));
				}
			}
			if(details.getKey().replace("%20","").trim().equals("filmId")) {
				if(details.getValue().getOperator().equals("equals") && StringUtils.isNumeric(details.getValue().getSearchValue()))
					builder.and(filmActor.filmId.eq(Integer.valueOf(details.getValue().getSearchValue())));
				else if(details.getValue().getOperator().equals("notEqual") && StringUtils.isNumeric(details.getValue().getSearchValue()))
					builder.and(filmActor.filmId.ne(Integer.valueOf(details.getValue().getSearchValue())));
				else if(details.getValue().getOperator().equals("range"))
				{
				   if(StringUtils.isNumeric(details.getValue().getStartingValue()) && StringUtils.isNumeric(details.getValue().getEndingValue()))
                	   builder.and(filmActor.filmId.between(Integer.valueOf(details.getValue().getStartingValue()), Integer.valueOf(details.getValue().getEndingValue())));
                   else if(StringUtils.isNumeric(details.getValue().getStartingValue()))
                	   builder.and(filmActor.filmId.goe(Integer.valueOf(details.getValue().getStartingValue())));
                   else if(StringUtils.isNumeric(details.getValue().getEndingValue()))
                	   builder.and(filmActor.filmId.loe(Integer.valueOf(details.getValue().getEndingValue())));
				}
			}
